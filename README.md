...
1. **GitHub Connection:**
   ...
   - Select this repository: `OneCoreDesign/PFSLCRM-Production`.
   - Branch: `main`.
...
*Note: All employee accounts and tasks have been cleared. Additional users can be added directly via the Admin dashboard.*
